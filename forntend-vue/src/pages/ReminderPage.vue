  ...
  <div id="reminderPage">
            ...
            <div class="reminders">
              <div class="section-header">
                <div class="header-left">
                  ...
                  >
                    <template #suffixIcon>
                      <i class="fas fa-calendar-alt" style="color: #ff8e53"></i>
                    </template>
                  </a-date-picker>
                </div>
                  ...
                  <template #renderItem="{ item }">
                    <a-list-item>
                      <div class="reminder-item">
                        <i v-if="item.completed" class="fas fa-check check-icon"></i>
                        <i v-else class="fas fa-clock clock-icon"></i>
                        ...
                        <div class="actions">
                          ...
                          >
                            <i v-if="item.important" class="fas fa-exclamation-circle important-icon"></i>
                            <i v-else class="far fa-exclamation-circle important-icon"></i>
                          </a-button>
              ...
              <div class="header-top">
                ...
                <div class="header-actions">
                  <van-button
                    ...
                    class="toggle-button"
                  >
                    <i v-if="showCompleted" class="fas fa-check-circle check-circle-icon"></i>
                    <i v-else class="far fa-check-circle check-circle-icon" style="opacity: 0.5"></i>
                  </van-button>
                  <van-button
                    type="primary"
                    size="small"
                    ...
                    class="add-button"
                  >
                    <i class="fas fa-plus add-icon-small"></i>
                  </van-button>
                </div>
              </div>
            </div>
              ...
              <van-cell-group class="reminder-group">
                ...
                >
                  <van-cell :border="false" class="reminder-content">
                    <template #icon>
                      <i v-if="item.completed" class="fas fa-check check-icon-mobile"></i>
                      <i v-else class="fas fa-clock clock-icon-mobile"></i>
                    </template>
                    <template #title>
                      <div class="reminder-title">
                        <div class="content-wrapper">
                          ...
                          <div class="badges">
                            <i v-if="item.starred" class="fas fa-star star-icon-mobile" @click="toggleStarred(item)"></i>
                            <i v-else class="far fa-star star-icon-mobile" @click="toggleStarred(item)"></i>
                            <i v-if="item.important" class="fas fa-exclamation-circle important-icon-mobile" @click="toggleImportant(item)"></i>
                            <i v-else class="far fa-exclamation-circle important-icon-mobile" @click="toggleImportant(item)"></i>
                          </div>
                        </div>
                  ...
                  <template #right>
                    ...
                    >
                      <i v-if="!item.completed" class="fas fa-check check-icon-btn"></i>
                      <i v-else class="fas fa-undo undo-icon-btn"></i>
                    </van-button>
                    <van-button
                      square
                      type="danger"
                    ...
                    >
                      <i class="fas fa-trash-alt delete-icon-btn"></i>
                    </van-button>
                  </template>
                </van-swipe-cell>
              </van-cell-group>
    ...
    <div v-if="showAddModal" class="modal-overlay" @click="closeAddModal">
      <div class="modal-content" @click.stop>
        <div class="modal-header">
          <h3>添加提醒</h3>
          <i class="fas fa-times close-icon" @click="closeAddModal"></i>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="reminder-options">
            ...
            >
              <i v-if="!isStarred" class="far fa-star option-icon"></i>
              <i v-else class="fas fa-star option-icon"></i>
              <span>收藏</span>
            </div>
            <div
              class="option-item"
            ...
            >
              <i v-if="!isImportant" class="far fa-exclamation-circle option-icon"></i>
              <i v-else class="fas fa-exclamation-circle option-icon"></i>
              <span>重要</span>
            </div>
          </div>
        </div>
    ...
    <div v-if="showContentModal" class="modal-overlay" @click="closeContentModal">
      <div class="modal-content" @click.stop>
        <div class="modal-header">
          <h3>提醒详情</h3>
          <i class="fas fa-times close-icon" @click="closeContentModal"></i>
        </div>
        <div class="modal-body">
          <div class="reminder-info">
            <div class="time-badge">
              <i class="fas fa-clock time-badge-icon"></i>
            ...
            <div class="reminder-options">
              ...
              >
                <i v-if="!currentReminder?.starred" class="far fa-star option-icon"></i>
                <i v-else class="fas fa-star option-icon"></i>
                <span>收藏</span>
              </div>
              <div
              ...
              >
                <i v-if="!currentReminder?.important" class="far fa-exclamation-circle option-icon"></i>
                <i v-else class="fas fa-exclamation-circle option-icon"></i>
                <span>重要</span>
              </div>
            </div>
        ...
        <div class="detail-footer">
          <div class="detail-actions">
            <div class="action-group">
              ...
              >
                <i v-if="selectedItem?.starred" class="fas fa-star star-icon"></i>
                <i v-else class="far fa-star star-icon"></i>
              ...
              >
                <i v-if="selectedItem?.important" class="fas fa-exclamation-circle important-icon"></i>
                <i v-else class="far fa-exclamation-circle important-icon"></i>
