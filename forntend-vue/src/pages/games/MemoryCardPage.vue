  ...
  <div class="memory-game-container">
    ...
    <div class="game-controls">
      ...
      <button class="control-btn" @click="toggleSound">
        <component :is="gameState.isMuted ? 'AudioMutedOutlined' : 'SoundOutlined'" />
...
import { ReloadOutlined, SoundOutlined, AudioMutedOutlined, TrophyOutlined } from '@ant-design/icons-vue'
