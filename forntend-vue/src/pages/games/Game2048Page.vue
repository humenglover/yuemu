...
.game-container {
  ...
  border-radius: 0;
  box-shadow: 12px 12px 0px #bbada0;
}
...
.game-title {
  ...
  letter-spacing: 2px;
  background: linear-gradient(45deg, #ff6b35, #f7931e, #ffd23f, #06ffa5, #118ab2, #073b4c);
...
/* 像素风格的按钮点击效果 */
.pixel-click {
  animation: pixelClick 0.1s ease;
}

@keyframes pixelClick {
  0% {
...
.game-over-modal {
  ...
  box-shadow: 12px 12px 0px #776e65;
  min-width: 300px;
  max-width: 90%;
  font-family: 'Press Start 2P', 'Courier New', monospace;
}
...
.ranking-item {
  ...
  box-shadow: 4px 4px 0px #bbada0;
}

.ranking-item:hover {
  transform: translate(2px, 2px);
  box-shadow: 2px 2px 0px #bbada0;
}
