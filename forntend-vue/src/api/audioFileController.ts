...
/** batchDeleteAudio DELETE /api/audio/admin/delete/batch */
export async function batchDeleteAudioUsingDelete(
  body: number[],
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/audio/admin/delete/batch', {
    method: 'DELETE',
    headers: {
...
/** listAudioByPageAdmin GET /api/audio/admin/list */
export async function listAudioByPageAdminUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listAudioByPageAdminUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAudioFile_>('/api/audio/admin/list', {
    method: 'GET',
    params: {
      ...params,
    },
