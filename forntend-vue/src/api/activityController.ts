...
/** listActivityBySpaceId POST /api/activity/list/page/space */
export async function listActivityBySpaceIdUsingPost(
  body: API.ActivityQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageActivity_>('/api/activity/list/page/space', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
